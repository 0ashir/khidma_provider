      ...
      return Stack(alignment: Alignment.bottomCenter, children: [
        SingleChildScrollView(
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const VSpace(Sizes.s20),
            if (value.bookingModel?.serviceProofs?.isNotEmpty == true)
            ...
            if (value.bookingModel?.serviceProofs != null &&
                value.bookingModel!.serviceProofs!.isNotEmpty)
              const VSpace(Sizes.s20),
            if (value.bookingModel?.service?.reviews?.isNotEmpty == true)
              Column(
                children: [
                  HeadingRowCommon(
                      isViewAllShow:
                          (value.bookingModel?.service?.reviews?.length ?? 0) >= 10,
                  ...
                  ...value.bookingModel!.service!.reviews!.asMap().entries.map(
                      (e) => SizedBox(
                                ...
                                ListTile(
                                  ...
                                  leading: (e.value.consumer?.media?.isNotEmpty == true)
                                      ? CachedNetworkImage(
                                          imageUrl: e.value.consumer!.media!.first
                                                  .originalUrl ??
                                              "",
                                          imageBuilder:
        ...
        if (isServiceman || isFreelancer)
          ...
          value.bookingModel?.service?.type != "remotely"
              ? Material(
                  elevation: 20,
                  child: value.bookingModel?.serviceProofs?.isNotEmpty == true
                      ? ButtonCommon(
